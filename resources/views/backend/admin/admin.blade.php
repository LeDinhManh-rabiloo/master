        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <ul class="nav navbar-right top-nav">
                ...
                <li class="dropdown">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    	<i class="" style="color:green;">{{Auth::user()->name}}</i> 
                    	<b class="caret"></b></a>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li class="active">
                        <a href="{{url('admin/home')}}"><i class="fa fa-fw fa-dashboard"></i> Trang chủ</a>
                    </li>
                    <li>
                        <a href="{{url('admin/user/list')}}"><i class="fa fa-fw fa-bar-chart-o"></i> Quản lý users</a>
                    </li>
                    <li>
                        ...
                        <ul id="demo" class="collapse">
                            <li>
                                <a href="{{url('admin/blog/list')}}">Danh sách bài viết</a>
                            </li>
                            <li>
                                <a href="{{url('admin/catalog_blog/list')}}">Danh mục bài viết</a>
                            </li>
                        </ul>
                    </li>
                    <li>
